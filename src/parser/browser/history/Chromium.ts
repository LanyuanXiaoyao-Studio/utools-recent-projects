...
export const applications: Array<ApplicationImpl<ChromiumHistoryProjectItemImpl>> = [
    ...
    new ChromiumHistoryApplicationImpl('qq', 'QQ Browser', CHROMIUM, [Platform.win32], true, undefined, configName),
    new ChromiumHistoryApplicationImpl('maxthon', 'Maxthon (傲游)', CHROMIUM, [Platform.win32], true, undefined, configName),
    ...
    new ChromiumHistoryApplicationImpl('liebao', '猎豹浏览器', CHROMIUM, [Platform.win32], true, undefined, configName),
    new ChromiumHistoryApplicationImpl('deepin', '深度浏览器', CHROMIUM, [Platform.linux], true, undefined, configName),
    new ChromiumHistoryApplicationImpl('xiaobai', '小白浏览器', CHROMIUM, [Platform.win32], true, undefined, configName),
]
