...
1. 市场版会**拥有开源版没有的功能**；目前计划有两类：**uTools 会员可用功能**，如插件使用统计（已上线），和**付费功能**（目前还没有）；功能的差异化是希望能够丰富 uTools 的付费生态，能够让 uTools 活得更长久一点；  
...
2. 市场版会**比开源版获得更积极的维护**；理由除了上一条提到的外，还包括本代码开源的目的，开源的其中一个重要意义是分享开发思路和经验，从来都不是为了让不愿意付费的人白嫖开发者的劳动，插件提供了部分软件的完整的历史记录获取方式，相信这对很多工具和很多人的需求有积极的意义，参考我的实现思路，去做自己的工具，这是这份开源代码的核心目标；至于及时响应用户需求，修复插件 bug 这些事情，会反映在市场版插件里，而不是开源代码。  
