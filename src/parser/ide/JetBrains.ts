...
export class JetBrainsApplicationImpl extends ApplicationCacheConfigAndExecutorImpl<JetBrainsProjectItemImpl> {
    constructor(id: string, name: string | NameGetter, homepage: string = '', icon: string, platform: Array<Platform> = [Platform.win32, Platform.darwin, Platform.linux], description: string | DescriptionGetter = '', beta: boolean = false, configFilename: string = 'recentProject.xml') {
